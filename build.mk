...
${TARGET_SRC_FILENAME_EXE}: ${LOPTS_FILE} ${SCF_FILE_NAME} ${OBJS_FOLDER} ${PROJ_OBJS} ${LOPTS_FILE}
	$(call MK_ECHO,Building STBIN archive for Allystar check)
	$(call MK_TC_GENAR,"${OBJS_FOLDER}/libsta8090_arm9_stbin_gcc4x.a", "${OBJS_FOLDER}/hdbin.o" "${OBJS_FOLDER}/stbin.o" "${OBJS_FOLDER}/stbin_dr_plugin.o" "${OBJS_FOLDER}/stbin_stagps_plugin.o" "${OBJS_FOLDER}/stbin_waas_plugin.o")
	$(call MK_CP,"${OBJS_FOLDER}/libsta8090_arm9_stbin_gcc4x.a","${LIBS_FOLDER}/libsta8090_arm9_stbin_gcc4x.a")
	$(call MK_RMFILE,"${OBJS_FOLDER}/libsta8090_arm9_stbin_gcc4x.a")
